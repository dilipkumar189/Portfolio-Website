...
const Mandal = () => {
  const MandalIconStyle =
    "absolute -top-5 left-[50%] translate-x-[-50%] h-8 w-7";
  return (
    <div className="w-full aspect-square relative">
      <div className="w-full h-full absolute animate-[spin_20s_linear_infinite] border border-primary rounded-full">
        <img src={codeigniter} className={MandalIconStyle} />
      </div>
      ...
      <div className="absolute rotate-90 w-full h-full">
        <div className="h-full w-full animate-[spin_20s_linear_infinite] rounded-full">
          <img src={electron} className={MandalIconStyle} />
        </div>
      </div>
      <div className="absolute -rotate-90 w-full h-full">
        <div className="h-full w-full animate-[spin_20s_linear_infinite] rounded-full">
          <img src={bootstrap} className={MandalIconStyle} />
        </div>
      </div>
      <div className="absolute rotate-45 w-[80%] h-[80%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div className="h-full w-full animate-[spin_24s_linear_infinite] border border-primary rounded-full">
          <img src={mysql} className={MandalIconStyle} />
        </div>
      </div>
      <div className="absolute rotate-[225deg] w-[80%] h-[80%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
      ...
      <div className="absolute rotate-[210deg] w-[60%] h-[60%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div className="h-full w-full animate-[spin_18s_linear_infinite] rounded-full">
          <img src={ts} className={MandalIconStyle} />
        </div>
      </div>
      ...
      <div className="absolute rotate-[120deg] w-[40%] h-[40%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div className="h-full w-full animate-[spin_18s_linear_infinite] border border-primary rounded-full">
          <img src={redux} className={MandalIconStyle} />
        </div>
      </div>
      ...
      <div className="absolute rotate-[120deg] w-[20%] h-[20%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div className="h-full w-full animate-[spin_10s_linear_infinite] border border-primary rounded-full">
          <img src={JS} className={MandalIconStyle} />
        </div>
      </div>
      <div className="absolute rotate-[300deg] w-[20%] h-[20%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div className="h-full w-full animate-[spin_10s_linear_infinite] rounded-full">
          <img src={react} className={MandalIconStyle} />
        </div>
      </div>
